...
public class PanelManager : MonoBehaviour
{
    ...
    public static bool UnregistPanel(Type PanelClassType)
    {
        if (!Panels.ContainsKey(PanelClassType))
        {
            Debug.LogError("UnregistPanel Error! Cant`t FInd Type! PanelClassType = " + PanelClassType.ToString());
            return false;
        }
    ...
    public static BasePanel GetPanel(Type PanelClassType)
    {
        if (!Panels.ContainsKey(PanelClassType))
        {
            Debug.LogError("GetPanel Error! Cant`t FInd Type! PanelClassType = " + PanelClassType.ToString());
            return null; 
        }
